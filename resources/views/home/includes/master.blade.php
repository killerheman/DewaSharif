...
<body class="homebody">
    ...
    <div style="background: #0b5e36; color: #ffffff; padding: 10px 15px; text-align: center; font-size: 14px; font-weight: 600; position: relative; z-index: 99999; box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
        🎉 Dewa Mela 2026 Dates: 27th Oct – 5th Nov  <br>
        <a href="#stay" style="color: #ffeb3b; text-decoration: underline; margin-left: 6px;">Check Stays, Hotels &amp; Guest Houses Nearby !!Soon!!</a>
    </div>
