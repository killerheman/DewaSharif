...
<div class="container">
    <div class="maroon">
        <h1>*** Abu Bakr Siddique (R.A.) ***</h1>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <p>
                Abu Bakr Siddique, also known as Abu Bakr Al-Siddiq, was a close companion of the Prophet Muhammad
                (peace be upon him) and the first Caliph of Islam. He holds a highly respected place in Islamic history,
                known for his piety, wisdom, and unwavering support for the Prophet and the early Muslim community.
            <div class="col-sm-12">
                <img src="{{asset('home/images/dewasharif/sahaba/abubakrsiddiq.jpg')}}" alt="" style="width: 100%">
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                ...
                <b>
                    <h5>Birth:</h5>
                </b> He was born in 573 CE in Mecca, into the Quraysh tribe, specifically the Banu Taym clan. His full
                ...
                <b>
                    <h5>Relationship with the Prophet:</h5>
                </b> Abu Bakr was among the Prophet’s closest friends even before the advent
                ...
                <h4>Contributions During the Prophet’s Life:</h4>
                <b>
                    <h5>Support for the Prophet:</h5>
                </b> Abu Bakr was known for his unwavering loyalty and support to the Prophet
                ...
                <b>
                    <h5>Migration to Medina:</h5>
                </b> He accompanied the Prophet during the Hijrah (Migration) from Mecca to Medina, a
                ...
                <b>
                    <h5>Role in Battles:</h5>
                </b> Abu Bakr participated in key battles like Badr, Uhud, and Khandaq, standing by the
                Prophet's side during difficult times. He demonstrated courage, humility, and dedication to the Islamic
                cause.

                <h4>Caliphate:</h4>
                <b>
                    <h5>Becoming the First Caliph:</h5>
                </b> After the death of the Prophet Muhammad in 632 CE, Abu Bakr was chosen as the
                ...
                <b>
                    <h5>Reunification of the Arabian Peninsula:</h5>
                </b> One of Abu Bakr's first challenges as Caliph was to deal with
                ...
                <b>
                    <h5>Compilation of the Quran:</h5>
                </b> Abu Bakr initiated the compilation of the Quran into a single written text
                ...
                <b>
                    <h5>Expansion of the Islamic State:</h5>
                </b> During his brief two-year rule, Abu Bakr also initiated campaigns to
                ...
                <b>
                    <h5>Passing Away:</h5>
                </b> Abu Bakr passed away in 634 CE, just two years after becoming the Caliph. He was buried
                beside the Prophet Muhammad in the chamber of Aisha, within the Prophet’s Mosque (Al-Masjid an-Nabawi)
                in Medina.

                <b>
                    <h5>Character and Qualities:</h5>
                </b> Abu Bakr was known for his humility, gentleness, and deep commitment to
                ...
                <h4>Titles and Honors:</h4>
                <b>
                    <h5>Al-Siddiq (The Truthful):</h5>
                </b> This title was given to him due to his immediate and firm belief in the Isra
                and Mi'raj, the miraculous night journey of the Prophet, when many doubted it.

                <b>
                    <h5>Companion of the Cave:</h5>
                </b> His close companionship with the Prophet during the Hijrah journey is a pivotal
                part of his legacy, symbolizing his loyalty and devotion.

                <b>
                    <h5>Significance in Islam:</h5>
                </b>
